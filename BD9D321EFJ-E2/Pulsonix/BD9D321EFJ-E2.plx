...
(library Library_1
	...
	(compDef "BD9D321EFJ-E2" (originalName "BD9D321EFJ-E2") (compHeader (numPins 8) (numParts 1) (refDesPrefix PS)
		...
		(compPin "3" (pinName "VREG") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "BOOT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "SW") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://rohmfs.rohm.com/en/products/databook/datasheet/ic/power/switching_regulator/bd9d321efj-e.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "BD9D321EFJ-E2.stp")
